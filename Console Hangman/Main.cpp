    ...
    if (!dictionary.empty()) {
        while (main_menu == 1) {
            ...
            if (!dictionary.empty()) {
                ...
                std::cout << "\aUnfortunately, there are no more words in the dictionary." << std::endl;
                std::cout << std::endl;
                system("pause");
                main_menu = 0;
            }
        ...
        std::cout << "\aError: Dictionary should have at least one topic and one word." << std::endl;
        system("pause");
    }
}